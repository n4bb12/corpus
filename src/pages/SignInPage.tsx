...
export function SignInPage() {
	...
	return (
		<AuthShell>
			<motion.div
				className="mx-auto flex w-full max-w-[22rem] flex-col justify-center rounded-2xl border border-border bg-card p-5 shadow-(--shadow-pine) sm:max-w-[26rem] sm:p-6 md:max-w-[30rem] md:aspect-2/3 md:p-10 lg:max-w-[32rem] lg:p-12"
