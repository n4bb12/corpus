...
- **Source digest** — short grounded summary of a ready Source, with supporting Citation quotes.
...
- **Evidence** — the packed chunk/digest context used to ground one answer turn.
...
- **Evidence pack** — classify, retrieve/rerank or digest-pack, and format prompt-ready evidence for an Answer turn.
